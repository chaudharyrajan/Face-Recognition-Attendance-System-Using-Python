...
class Face_Recognition:
    def __init__(self,root): 
        ...
        img_left=Image.open(r"C:\Users\rajan\OneDrive\Pictures\face1.jpg")
        img_left=img_left.resize((675,640),Image.ANTIALIAS)
        self.photoimg_left=ImageTk.PhotoImage(img_left)
    
        f_lbl=Label(self.root,image=self.photoimg_left)
        f_lbl.place(x=0,y=50,width=675,height=640)
                
        # button face scanning
        b1_1=Button(f_lbl,text="Face Scanning",command=self.face_recog,cursor="hand2",font=("times new roman",20,"bold"),bg="red",fg="white")
        b1_1.place(x=300,y=500,width=200,height=50)
        
        img_right=Image.open(r"C:\Users\rajan\OneDrive\Pictures\face2.jpg")
        img_right=img_right.resize((675,640),Image.ANTIALIAS)
        self.photoimg_right=ImageTk.PhotoImage(img_right)
    
        f_lbl=Label(self.root,image=self.photoimg_right)
        f_lbl.place(x=675,y=50,width=675,height=640)
     ##         Addendance marks=========
